...
func (_MyContract *MyContractCaller) TokenURI(opts *bind.CallOpts, _tokenId *big.Int) (string, error) {
	var out []interface{}
	err := _MyContract.contract.Call(opts, &out, "tokenURI", _tokenId)
...
//
// Solidity: function tokenURI(uint256 _tokenId) view returns(string)
func (_MyContract *MyContractSession) TokenURI(_tokenId *big.Int) (string, error) {
	return _MyContract.Contract.TokenURI(&_MyContract.CallOpts, _tokenId)
}

// TokenURI is a free data retrieval call binding the contract method 0xc87b56dd.
//
// Solidity: function tokenURI(uint256 _tokenId) view returns(string)
func (_MyContract *MyContractCallerSession) TokenURI(_tokenId *big.Int) (string, error) {
	return _MyContract.Contract.TokenURI(&_MyContract.CallOpts, _tokenId)
}

// CheckOnERC721Received is a paid mutator transaction binding the contract method 0x1fd01de1.
//
// Solidity: function _checkOnERC721Received(address from, address to, uint256 tokenId, bytes data) returns(bool)
func (_MyContract *MyContractTransactor) CheckOnERC721Received(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _MyContract.contract.Transact(opts, "_checkOnERC721Received", from, to, tokenId, data)
}

// CheckOnERC721Received is a paid mutator transaction binding the contract method 0x1fd01de1.
//
// Solidity: function _checkOnERC721Received(address from, address to, uint256 tokenId, bytes data) returns(bool)
func (_MyContract *MyContractSession) CheckOnERC721Received(from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _MyContract.Contract.CheckOnERC721Received(&_MyContract.TransactOpts, from, to, tokenId, data)
}

// CheckOnERC721Received is a paid mutator transaction binding the contract method 0x1fd01de1.
//
// Solidity: function _checkOnERC721Received(address from, address to, uint256 tokenId, bytes data) returns(bool)
func (_MyContract *MyContractTransactorSession) CheckOnERC721Received(from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _MyContract.Contract.CheckOnERC721Received(&_MyContract.TransactOpts, from, to, tokenId, data)
}
...
// MakeAnEpicNFT is a paid mutator transaction binding the contract method 0xde9d132f.
//
// Solidity: function makeAnEpicNFT() returns()
func (_MyContract *MyContractTransactor) MakeAnEpicNFT(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _MyContract.contract.Transact(opts, "makeAnEpicNFT")
}

// MakeAnEpicNFT is a paid mutator transaction binding the contract method 0xde9d132f.
//
// Solidity: function makeAnEpicNFT() returns()
func (_MyContract *MyContractSession) MakeAnEpicNFT() (*types.Transaction, error) {
	return _MyContract.Contract.MakeAnEpicNFT(&_MyContract.TransactOpts)
}

// MakeAnEpicNFT is a paid mutator transaction binding the contract method 0xde9d132f.
//
// Solidity: function makeAnEpicNFT() returns()
func (_MyContract *MyContractTransactorSession) MakeAnEpicNFT() (*types.Transaction, error) {
	return _MyContract.Contract.MakeAnEpicNFT(&_MyContract.TransactOpts)
}
